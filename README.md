...
Esse desafio tem a intenção de criar uma aplicação em Node.js + TypeScript, utilizando o conceito de models, repositories e services!

É uma aplicação para armazenar transações financeiras de entrada e saída, que permite o cadastro e a listagem dessas transações.
...
Essa aplicação tem os seguintes testes:
